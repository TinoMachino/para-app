...
import {Upvote_Stroke2_Corner0_Rounded as UpArrow} from '#/components/icons/ArrowTriangle'
    ...
    <View style={[styles.post, style]}>
      ...
      <View style={[s.flex1]}>
        ...
        <View style={styles.postCtrls}>
          ...
          <View style={[styles.postCtrl, {marginLeft: 30}]}>
            <View style={styles.postBtn}>
              <Bubble
                style={[
                  {
  ...
  return (
    <View style={[styles.notification, style]}>
      <View style={[{width: 60}, a.align_end, a.pr_sm, a.pt_2xs]}>
        <UpArrow width={32} style={{color: t.palette.contrast_50}} />
      </View>
      <View style={{flex: 1}}>
