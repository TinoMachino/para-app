          ...
          <Layout.Center style={styles.center}>
            ...
            <View style={styles.row}>
              <View style={[styles.inputGroup, {flex: 1}]}>
                ...
                <TextInput
                  accessibilityLabel="Campo de comunidad"
                  accessibilityHint="Ingresa la comunidad asociada a la propuesta, por ejemplo p/Jalisco"
              ...
              <View style={[styles.inputGroup, {flex: 1}]}>
                ...
                <TextInput
                  accessibilityLabel="Campo de región opcional"
                  accessibilityHint="Ingresa una región si la propuesta aplica a una zona específica, por ejemplo CDMX"
                  style={[styles.input, t.atoms.bg_contrast_25, t.atoms.text]}
                  placeholder="Ej. CDMX"
                  placeholderTextColor={t.palette.contrast_500}
                  value={region}
