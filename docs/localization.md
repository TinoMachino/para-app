...
We want PARA to be available in as many languages as possible. If you want to help with translation work, open an issue or pull request in this repository first so maintainers can confirm the current localization workflow.

## Tools

- We use Crowdin to manage translations where applicable.
...
Crowdin is the preferred tool for managing translations when the maintainers have configured a project for the current release. There are two roles:
...
You can request a new language by opening a GitHub issue in this repository.
