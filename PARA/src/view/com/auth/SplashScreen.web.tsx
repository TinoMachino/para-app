...
function Footer() {
  ...
  return (
    <View
      ...
      <InlineLinkText
        label={_(msg`Learn more about PARA`)}
        to="https://bsky.social">
        <Trans>Business</Trans>
      </InlineLinkText>
      <InlineLinkText
        label={_(msg`Read the PARA blog`)}
        to="https://bsky.social/about/blog">
        <Trans>Blog</Trans>
      </InlineLinkText>
      <InlineLinkText
        label={_(msg`See jobs at PARA`)}
        to="https://bsky.social/about/join">
        <Trans comment="Link to a page with job openings at PARA">Jobs</Trans>
      </InlineLinkText>
