...
export class ComParaPostRecord {
  ...
  async create(
    params: OmitKey<ComAtprotoRepoCreateRecord.InputSchema, 'collection'>,
    opts?: ComAtprotoRepoCreateRecord.CallOptions,
  ): Promise<{ uri: string; cid: string }> {
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
  ...
  async put(
    params: OmitKey<ComAtprotoRepoPutRecord.InputSchema, 'collection'>,
    opts?: ComAtprotoRepoPutRecord.CallOptions,
  ): Promise<{ uri: string; cid: string }> {
    const res = await this._client.call(
      'com.atproto.repo.putRecord',
...
export class ComParaSocialPostMetaRecord {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
    opts?: ComAtprotoRepoGetRecord.CallOptions,
  ): Promise<{ uri: string; cid?: string; value: ComParaSocialPostMeta.Record }> {
    const res = await this._client.call(
      'com.atproto.repo.getRecord',
      {
        collection: 'com.para.social.postMeta',
