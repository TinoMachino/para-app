  ...
  return (
    <View style={[a.h_full]}>
      <Layout.Content
        ...
        <Text style={style}>
          <Trans>
            PARA helps friends find each other by creating an encoded digital
...
function showPermissionDeniedAlert() {
  Alert.alert(
    ...
    t`You'll need to go to the System Settings for PARA and give permission if you want to use this feature.`,
    [
      {
        text: t`OK`,
        style: 'default',
